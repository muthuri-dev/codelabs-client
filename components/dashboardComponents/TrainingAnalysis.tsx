  ...
  return (
    <div className="border text-gray-500 w-full  p-3 rounded-2xl">
      ...
      <div className="flex items-center justify-between">
        ...
        <button className="border px-2 py-1 rounded-lg text-xs">Details</button>
      </div>
      ...
      <div className="flex justify-between">
        ...
        <div className="flex gap-1.5 items-end h-20">
          <motion.div
            ...
            className="w-3 h-14 rounded-sm duration-200 bg-violet-500/60"
          />
          <motion.div
            initial={{ height: 0 }}
            animate={{ height: "" }}
            transition={{ duration: 0.2 + 0.2 }}
            className="w-3 h-16 rounded-sm duration-200 bg-violet-500"
          />
          <motion.div
            initial={{ height: 0 }}
            animate={{ height: "" }}
            transition={{ duration: 0.2 + 0.4 }}
            className="w-3 h-12 rounded-sm duration-200 bg-violet-500/60"
          />
          <motion.div
            initial={{ height: 0 }}
            animate={{ height: "" }}
            transition={{ duration: 0.2 + 0.6 }}
            className="w-3 h-16 rounded-sm duration-200 bg-violet-500"
          />
          <motion.div
            initial={{ height: 0 }}
            animate={{ height: "" }}
            transition={{ duration: 0.2 + 0.8 }}
            className="w-3 h-14 rounded-sm duration-200 bg-violet-500/60"
          />
          <motion.div
            initial={{ height: 0 }}
            animate={{ height: "" }}
            transition={{ duration: 0.2 + 0.11 }}
            className="w-3 h-20 rounded-sm duration-200 bg-violet-500"
          />
          <motion.div
            initial={{ height: 0 }}
            animate={{ height: "" }}
            transition={{ duration: 0.2 + 0.13 }}
            className="w-3 h-12 rounded-sm duration-200 bg-violet-500/60"
          />
        </div>
      </div>
