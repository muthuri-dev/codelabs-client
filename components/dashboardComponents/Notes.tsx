      ...
      <div className="space-y-3">
        ...
        <div className="flex items-start gap-3 w-full">
          ...
          <div className="w-full space-y-1">
            ...
            <p className="text-xs">
              Search for inspiration to create landing page for AI startup.
            </p>
            <div className="flex justify-between items-end">
              <div className="space-x-2 font-medium">
                <button className="text-xs px-1 py-0.5 rounded-full bg-red-100 text-red-500">
                  Today
                </button>
                <button className="text-xs px-1 py-0.5 rounded-full bg-orange-100 text-orange-500">
                  To-do
                </button>
              </div>
        ...
        <div className="flex items-start gap-3 w-full opacity-70">
          ...
          <div className="w-full space-y-1">
            ...
            <p className="text-xs">
              Discuss about client requirements and deadline.
            </p>
            <div className="flex justify-between items-end">
              <div className="space-x-2 font-medium">
                <button className="text-xs px-1 py-0.5 rounded-full bg-violet-100 text-violet-500">
                  Team
                </button>
                <button className="text-xs px-1 py-0.5 rounded-full bg-orange-100 text-orange-500">
                  Meeting
