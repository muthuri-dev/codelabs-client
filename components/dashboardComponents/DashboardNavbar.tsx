  ...
  return (
    <div>
      <div className="flex p-4 justify-between items-center">
        ...
        {/* right section */}
        <div className="  text-gray-500 hidden md:flex gap-1">
          ...
          <button className="h-8 gap-1 bg-primary hidden py-1 px-1 duration-200 text-white rounded-lg text-xs md:flex items-center justify-center">
            <Add size={16} />
