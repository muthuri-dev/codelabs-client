...
function EmployeeSpotlight() {
  ...
  return (
    <div className="border text-gray-500 w-full p-3 rounded-2xl space-y-4">
      ...
      {/* tabs */}
      <div className="flex -z-20 text-xs font-medium relative bg-gray-100 p-2 rounded-lg py-1">
        <button
          onClick={() => setActiveTab("overview")}
          className={`z-10 w-full px-2 py-1 ${
            activeTab === "overview" ? "" : ""
          }`}
        >
          Overview
        ...
        <button
          ...
          className={`z-10 w-full px-2 py-1.5 rounded-lg ${
            activeTab === "comments" ? "" : ""
          }`}
        >
          Comments
      ...
      <div className="space-y-3">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div className="font-medium">
              <p className="text-xs text-gray-500">Dwayne Johnson</p>
              <p className="text-xm text-gray-700 font-thin">Looks insane!🔥</p>
            </div>
          </div>
          <button
        ...
        >
          <div className="flex items-center gap-2">
            ...
            />
            <div className="font-medium">
              <p className="text-xs text-gray-500">Steve Smith</p>
          ...
          <button
            onClick={() => setComment2Liked(!comment2Liked)}
            className={`${
              comment2Liked ? "text-red-500" : "text-gray-400"
            } duration-200 active:scale-50`}
          >
